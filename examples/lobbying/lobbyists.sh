...
sed '1 s/$/,"Award Amount","Vendor ID"/' | \
sed '2,$s/$/,,/' | \
csvcut -c "CLIENT NAME","Full Address","CLIENT CITY","CLIENT STATE","CLIENT ZIP","Award Amount","Vendor ID","Client Industry" > \
lobbyists.csv
...
sed '2,$s/$/,/' | \
csvcut -c "Vendor Name","Full Address","City","State","Zip","Award Amount","Vendor ID","Client Industry" > \
contracts.csv
