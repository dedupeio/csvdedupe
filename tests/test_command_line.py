...
class TestInputAPI(unittest.TestCase) :
    ...
    def test_no_parameters(self):
      ...
      child.expect('error: You must provide an input_file')
    ...
    def test_no_training(self) :
      child = pexpect.spawn('dedupe --input_file examples/csv_example_messy_input.csv --field_names "Site name" Address Zip Phone --training_file foo.json --skip_training')
